...
TEST(UtilsGenerateRandomIndex, BigSet) {
...
TEST(UtilsGenerateRandomIndex, OverflowSet) {
...
TEST(UtilsParseCommandLineArguments, PasswordLengthIsNumber) {
...
TEST(UtilsParseCommandLineArguments, PasswordLengthIsString) {
...
TEST(UtilsParseCommandLineArguments, PasswordLengthIsSpecialCharacter) {
...
TEST(UtilsParseCommandLineArguments, MultipleShortOptionsWithLengthAndCustom) {
